...
export const en = {
  ...
  sprint: {
    ...
    empty: {
      ...
      body: "Sprints set the cadence for your bets. Create your first one to get moving.",
      cta: "Create your first sprint",
    },
    card: {
      countdown: "{days} days left",
      nextSignalCheck: "Next signal check",
      nextReview: "Next strategic review",
      reviewMilestone: "{percent}% milestone",
      allReviewsDone: "All reviews complete",
      noUpcomingChecks: "No further checks",
    },
    newForm: {
      title: "New sprint",
      subtitle: "Set the cadence for {org}.",
      nameLabel: "Sprint name",
      startDateLabel: "Start date",
      durationLabel: "Duration (days)",
      durationHint: "Level {level}: {min}–{max} days (default {default})",
      endDatePreview: "Ends {date}",
      submit: "Create sprint",
      cancel: "Cancel",
    },
    toast: {
      activeExists: "There’s already an active sprint. Close it before activating another.",
      activated: "Sprint activated.",
      closed: "Sprint closed.",
    },
    errors: {
      generic: "Something went wrong. Please try again.",
      rateLimited: "Too many requests. Please wait a moment and try again.",
      nameRequired: "Enter a sprint name.",
      invalidDate: "Enter a valid start date.",
      notFound: "That sprint could not be found.",
      notAllowed: "You don’t have permission to do that.",
      durationRange: "Duration must be between {min} and {max} days for this level.",
      activeExists: "There’s already an active sprint in this org.",
      invalidTransition: "That sprint can’t be activated.",
      closeNotOnTrial: "Closing sprints isn’t available on the trial plan. Upgrade to unlock it.",
    },
  },
  org: {
    levelBadge: "L{level}",
